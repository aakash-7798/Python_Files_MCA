...
# 17.Write Python program to implement the deque (double ended queue) ADT using
...
class deque:
    ...
    def print_list_reverse(self):
        if self.front is None:
            ...
            hd,tl = self.front.data, self.rear.data
            temp = self.rear
            print("Deque Elements -> [",end='')
            while temp is not self.front:
                ...
                temp = temp.prev
            print(f"{temp.data}]")
            print("Front = ",tl," Rear = ",hd," Size=",self.size,'\n')
